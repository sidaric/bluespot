...
const toggle = (btnId,inputId,eyeId,eyeOffId) => {
...
toggle('togglePassword','password','iconEye1','iconEyeOff1');
toggle('togglePassword2','password_confirmation','iconEye2','iconEyeOff2');
